//Task object.  Added the Flyweight property.
...
var FlyweightFactory = function () {
    ...
    //Ask for a flyweight.  it's a subset of a task for us.  the only thing that is unique about the Task object is this.name.
...
function TaskCollection() {
    ...
    // revealing module pattern that shows the three methods.
    return {
        add: add,
        get: get,
        getCount: getCount,
